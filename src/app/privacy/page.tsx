        ...
        <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
            <div className="container mx-auto px-6 py-32 max-w-4xl">
                ...
                <div className="space-y-12 theme-copy font-medium leading-relaxed">
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">01. Signal Intelligence</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">02. Node Messaging Protocols</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">03. Verification Data</h2>
                        <p>
                            Your phone number is required during initialization to prevent unauthorized node access and to provide critical signal alerts via neural SMS or WhatsApp notifications. We do not share your number with third-party grid entities.
                        </p>
                    </section>

                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">04. Encryption Standards</h2>
                        <p>
