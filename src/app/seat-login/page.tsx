        ...
        <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
            ...
            <div className="glass-card w-full max-w-md p-8 rounded-2xl shadow-2xl border border-border relative z-10">
                <div className="text-center mb-8">
                    ...
                    <p className="text-muted text-sm mt-1">Sign in to your team seat</p>
                </div>

                <form onSubmit={handleLogin} className="space-y-4">
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-muted uppercase ml-1">Email</label>
                    ...
                    <div className="space-y-1">
                        <label className="text-xs font-semibold text-muted uppercase ml-1">Password</label>
                        <div className="relative group">
