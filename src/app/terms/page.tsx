        ...
        <div className="min-h-screen bg-background text-foreground selection:bg-primary/30">
            <div className="container mx-auto px-6 py-32 max-w-4xl">
                ...
                <div className="space-y-12 theme-copy font-medium leading-relaxed">
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">01. Protocol Usage</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">02. Identity Verification</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">03. Node Responsibility</h2>
                        <p>
                    ...
                    <section>
                        <h2 className="theme-section-title mb-6 text-sm">04. Service Magnitude</h2>
                        <p>
