        ...
        <section className="py-24 relative overflow-hidden bg-background">
            ...
            <div className="container mx-auto px-6 mb-32">
                <div className="text-center mb-20">
                    ...
                    <h2 className="text-4xl lg:text-6xl font-black text-foreground">{c.title}</h2>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-12">
                    ...
                    >
                        <div className="bg-surface-dark rounded-[2.9rem] p-12 h-full flex flex-col justify-between">
                            ...
                            <p className="text-xl text-muted mb-10 leading-relaxed font-light">"{c.case1_text}"</p>
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-1 bg-red-600 rounded"></div>
                                <div className="text-xs font-bold text-muted uppercase">{c.case1_footer}</div>
                            </div>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="bg-surface-dark rounded-[2.9rem] p-12 h-full flex flex-col justify-between overflow-hidden relative">
                            ...
                            <div className="flex justify-between items-start mb-10">
                                <div className="text-4xl font-extrabold italic text-foreground tracking-widest uppercase">{c.case2_brand}</div>
                                <div className="px-4 py-1.5 glass-card rounded-full text-[10px] font-black uppercase text-purple-400">{c.case2_stat}</div>
                            </div>
                            <p className="text-xl text-muted mb-10 leading-relaxed font-light">"{c.case2_text}"</p>
                            <div className="flex items-center gap-4">
                                <div className="w-10 h-1 bg-foreground rounded"></div>
                                <div className="text-xs font-bold text-muted uppercase">{c.case2_footer}</div>
                            </div>
                        </div>
                    </motion.div>
                </div>
