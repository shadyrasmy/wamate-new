...
User.hasMany(ReferralTransaction, { foreignKey: 'referred_user_id', as: 'commission_sources' }); // Money generated by my payments

ReferralTransaction.belongsTo(User, { foreignKey: 'referrer_id', as: 'referrer' });
ReferralTransaction.belongsTo(User, { foreignKey: 'referred_user_id', as: 'referred_user' });
